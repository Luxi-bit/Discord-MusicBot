module.exports = {
  ...
  adminId: "488904563944849429", //- Replace UserId with the Discord ID of the admin of the bot
  token:
    process.env.token ||
    "OTc4OTU0Njc0MjY4OTM0MTY0.G49IHN.y6Gzy8Dg7HSQp5kR6xPUYr6oM99e4i9YZOGU-g", //- Bot's Token
  clientId: process.env.clientId || "978954674268934164", //- ID of the bot
  clientSecret: process.env.clientSecret || "MxierGx1_Zv3tyxBa7RhmGJ6GpBjjWPc", //- Client Secret of the bot
  port: 4200, //- Port of the API and Dashboard
  scopes: ["identify", "guilds", "applications.commands"], //- Discord OAuth2 Scopes
  serverDeafen: true, //- If you want bot to stay deafened
  defaultVolume: 100, //- Sets the default volume of the bot, You can change this number anywhere from 1 to 100
  supportServer: "https://discord.gg/rKZb9XjGpK", //- Support Server Link
  ...
  cookieSecret: "Chengs is Amazing", //- Cookie Secret
  ...
  embedColor: "#1cfc03", //- Color of the embeds, hex supported
  presence: {
